...
resources:
- description: Slides
  resource: https://slides.com/art049/demystifying-asyncio
- description: Code
  resource: https://github.com/art049/my-python-event-loop/
room: Forum Hall
session_type: Talk
sessions_after:
- NMBFTX
...
youtube_url: https://youtube.com/watch?v=Ww2HBNpu98g
---
