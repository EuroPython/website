...
prev_session: HZSGYK
resources:
- description: URL for the source code, slides and extended notes
  resource: https://github.com/Aiven-Labs/pgvector-find-faces-talk
- description: Direct link to PDF slides
  resource: https://github.com/Aiven-Labs/pgvector-find-faces-talk/blob/main/slides/slides-16x9.pdf
- description: Directl link to PDF notes
  resource: https://github.com/Aiven-Labs/pgvector-find-faces-talk/blob/main/slides/notes.pdf
room: South Hall 2B
session_type: Talk
sessions_after:
- N9VDEQ
...
youtube_url: https://youtube.com/watch?v=qXiprdhk87g
---
