...
resources:
- description: Slides
  resource: https://program.europython.eu/media/europython-2024/submissions/CCZPAF/resources/Adventures_in_Not_Testing.slides_f5TUwWD.html
room: North Hall
session_type: Talk
sessions_after:
- GGWUNA
...
youtube_url: https://youtube.com/watch?v=tp8-2qeYCwY
---
