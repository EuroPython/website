...
resources:
- description: Slides
  resource: https://loki.dev/ep24
- description: Overview (Slides/PDF/Repolink/etc.)
  resource: https://loki.dev/vortraege/europython2024-python-batteries-included/
- description: Repository
  resource: https://github.com/dev-loki/europython2024-python-unplugged-slides
room: South Hall 2B
...
track: Python Internals & Ecosystem (2024)
...
youtube_url: https://youtube.com/watch?v=W5ZOFvGmmbo
---
