...
prev_session: KBZTFP
resources:
- description: Permanent link to slides
  resource: https://slides.ucodery.com/you-are-sharing-your-code-wrong/
room: Terrace 2B
session_type: Talk
sessions_after:
- GGWUNA
...
youtube_url: https://youtube.com/watch?v=AMRHRNDVhEg
---
