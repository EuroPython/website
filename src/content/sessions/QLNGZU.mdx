...
prev_session: null
resources:
- description: Complete implementation of the demonstrated DIY lock files-based environment
    management
  resource: https://github.com/webknjaz/ep2024-multilock-toy-template
room: Club B
