...
prev_session: K77Z8V
resources:
- description: Testability and reusability in data pipelines
  resource: https://programme.europython.eu/media/europython-2024/submissions/R3P9UX/resources/Testability_and_reusability_in_data_pipelin_Ksqw7JM.pdf
room: North Hall
session_type: Talk
sessions_after:
- A3QRK3
...
youtube_url: https://youtube.com/watch?v=DUX-bEW1_bU
---
