...
description:
    ...
    **Development**
    ...
    As our next Staff Software Engineer, you won’t just be writing code—you’ll be the high-impact catalyst at the heart of our Kraków Hub, forcing clarity and raising the bar for engineering excellence across the entire ActiveCampaign platform. You will sit at the epicenter of our AI-first transformation, architecting agentic workflows that redefine marketing automation while simultaneously pioneering AI-assisted development practices that accelerate every team around you.
    
    
    This isn’t a role for someone who waits for a roadmap; it’s for a technical visionary who takes extreme ownership of the platform’s performance, scalability, and future trajectory. Whether you are embedding in a squad to unblock a complex AI integration or advising leadership on cross-cutting architectural debt, your influence will be the force multiplier that ensures our Kraków Hub remains a powerhouse of innovation. This is your opportunity to shape the direction of a world-class SaaS platform and see your contributions directly impact the way millions of users engage with intelligent automation
    
    
    **On a typical day, you might:**
    
    - **Drive technical direction** across multiple Kraków Hub teams, acting as a strategic advisor or embedding directly into squads when technical complexity demands a master-level touch.

    - **Architect scalable agentic AI features**, ensuring autonomous workflows and LLM integrations across platform subsystems—from CRM to email automation—are reliable and maintainable at scale.
    
    - **Identify and resolve platform-wide bottlenecks** with a whole-system perspective, optimizing everything from frontend rendering in React/Ember to deep backend logic in PHP and Python.

    - **Champion AI-assisted engineering practices**, leading the evaluation and adoption of cutting-edge tools (like Copilot, Cursor, or Devin) to transform how our internal teams build and test software.
