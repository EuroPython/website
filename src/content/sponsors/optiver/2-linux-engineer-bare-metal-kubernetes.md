---
title: "Linux Engineer - Bare Metal & Kubernetes"
location: "📍 Amsterdam"
type:
level: "Experienced"
tags:
...
description: |-
  As a Linux Engineer in the Global Linux team, you will design, build and operate the critical infrastructure that powers Optiver's trading environment. The team owns both large-scale bare-metal Linux platforms and on-prem Kubernetes clusters across our global datacenters.

  You'll play a key role in evolving our Kubernetes platform while continuing to support and improve our high-performance Linux estate.

responsibilities:
  - Design, deploy and operate on-prem Kubernetes clusters in a bare-metal environment (Rancher-managed)
  - Maintain and improve bare-metal Linux infrastructure, including provisioning, lifecycle management and performance tuning
  ...
  - Drive reliability, scalability and performance improvements across containerized and non-containerized workloads
  - Contribute to monitoring, observability and security posture across the Linux and Kubernetes platforms
  - Build clear documentation and operational runbooks so the broader team can effectively operate the platforms
...
requirements:
  ...
  - Experience with Rancher, Cilium (or other CNI technologies), ArgoCD (GitOps workflows), and Terraform
  ...
  - A production mindset, with experience in incident response and post-mortem-driven improvements
