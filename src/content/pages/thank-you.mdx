...
A big shoutout to Ege Akman and Niklas Mertsch for leading the efforts in setting up and managing our Discord server and the discord bot!
Their work on maintaining and updating the discord bot can be found on the [EuroPython discord bot repo](https://github.com/EuroPython/discord).

The discord sub-team also included the following members:
...
A huge shoutout to Panagiotis and Piotr for their amazing work with the digital screens and the communication with the venue and Gonzo for anything A/V related!
Huge thanks to Lais and Panagiotis for setting up and managing the interview booth!

The following people helped with the A/V setup and coordination:
...
Special thanks to the following people for leading the announcement and the selection of onsite volunteers:
...
Special thanks to the following people for leading the onboarding and the coordination of onsite volunteers:
...
- Jana Sloukova
- Karla Fejfarova
- Magdaléna Grassi Morong
- Marcela Karafizievová
- Mia Bajić
- Petr Lessner
...
## Social (Thursday) Event

We had an amazing social events at the historic Gabriel Loci with Board Games and Music jams! Here are those who made it possible
...
Many thanks to **Mia Bajić** for organising a fantastic **Speakers dinner** & to **Rodrigo Girao Serrao** for managing the **Sprints weekend** so effectively! We feel so grateful to work around such amazing people :)
