...
Before the conference you can leave us a note while ordering your tickets or you can contact us via email at helpdesk@europython.eu.

During the conference visit our Info Desk at registration or look for our volunteers wearing a yellow conference t-shirt. You can also try to contact us via Discord using the "support" channel – when doing so please be patient though.

If you need help for things like designated seating, maintaining clear pathways, ... feel free to speak to the volunteer coordinating the session In the main talk rooms as well.
