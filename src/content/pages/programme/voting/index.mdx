...
import voteOptions from "./voting.png";
...
- Evaluating more proposals will help your companion to keep growing! So we hope you can take good
  care of it.
- Even if it's very tempting, we encourage you to properly review talks before voting.
  Otherwise, your companion might suffer from a hasty review.
