...
subtitle:
  A summit to bring together maintainers and users of Python with WebAssembly, to discuss the state
  of this ecosystem, existing challenges, and ongoing work.
---

# WebAssembly Summit

The **WebAssembly Summit** aims to bring together maintainers and users of Python with WebAssembly,
to discuss the state of this ecosystem, existing challenges, and ongoing work.
...
- 9:00: Meet and greet (many of us won’t know each other) + unconference-y post-it based
  organisation.
...
The event is limited to 40 participants. If there is a topic you would like to present, please
indicate it in the form and _fill it in early_. Time slots are of 30min at most (10 min of
presentation + 20 min for questions/discussion).
