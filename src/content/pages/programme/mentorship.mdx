...
After the CfP we will have an online panel session with 2-3 experienced community members sharing advice for the first-time (or other) speakers. At the end of the panel, there will be a QnA session to answer all the participants' questions.
