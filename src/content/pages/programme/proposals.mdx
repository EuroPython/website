...
As a community-driven conference, we prioritize sessions that highlight open-source Python projects over paid solutions. If your company is interested in showcasing a paid product during a session, we offer dedicated sponsored talk slots. We encourage you to reach out to our sponsorship team at sponsoring@europython.eu to explore how you can secure one of these opportunities.

### Planning on submitting a tutorial?

Building on feedback from previous years, this year we’re emphasizing tutorials with a strong, hands-on component. In your proposal, please outline how you plan to incorporate active coding sections in your tutorial.
