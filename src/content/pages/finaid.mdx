...
<Note>
  ...
  <span className="block">If you haven’t heard from us, your application will <strong>automatically be considered for Round 2</strong>. No further action is needed.</span>
</Note>

<div class="bg-white text-black p-6 rounded-lg shadow-md my-6">
  <p class="font-bold text-xl mb-2">Applications are now open</p>
  <p class="mb-2"><strong>Deadline:</strong> 11 May 2026 (second round, [Anywhere on Earth][AoE])</p>
