...
<h5 id="shipping-deadline">Shipping: Arrive DB Schenker by Friday, July 4</h5>
- **[Parcel Delivery & Swag](#parcel-delivery--swag)**: all exhibitors who want to ship exhibit items (_Detailed deadlines specified in Shipping Guidelines Below_)


<h5 id="talk-deadline">TBD</h5>
...
<h5 id="booth-deadline">Sunday, June 8</h5>
...
<h5 id="registration-deadline">TBD</h5>

- **[Tickets Registration & Assignment](#registration)**: all sponsors

<h5 id="comms-deadline">TBD</h5>
...
<h5 id="presentation-deadline">TBD</h5>
...
**⏲️ Deadlines:** All shipments must arrive at DB Schenker by: **4 July 2025**. Details are specified in [**Shipping Guidelines & Address (doc)**](/sponsor-shipping/DB_Schenker_Shipping_Guidelines.doc).
...
**Submission Channel**: [Sponsor Assets Submission Form](TBD)
