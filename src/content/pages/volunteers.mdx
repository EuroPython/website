...
* A special group photo with all volunteers (time will be announced on the #onsite-volunteers channel on Discord)
...
* Sending people to the registration desk if they don't have one and are not from the venue (e.g. AV team, catering, etc.)
* Reporting people that don't have badges and don't want to go to the registration desk
...
<Button url="mailto:volunteers@europython.eu">volunteers @ europython.eu</Button>
</div>
