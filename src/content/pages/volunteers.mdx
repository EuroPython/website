...
* To enter the conference you need a ticket. Some volunteers are eligible for a free ticket, see perks below.
...
* You can get a free combined ticket (Tutorials + Conference) if you pledge to volunteer for ten (10) hours or more.

# Perks for volunteers

* A free combined ticket (Tutorials + Conference) if you volunteer for ten (10) hours or more!
