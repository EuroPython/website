...
* We would really appreciate if you can sign up for more than one slot.
...
* Have time between two talks? Then why not spend it as an EuroPython Volunteer on the spot?
