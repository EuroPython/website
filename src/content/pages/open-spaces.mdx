...
Check out the [schedule](https://ep2026.europython.eu/schedule/) to see the Open Spaces!

## How to Organise an Open Space

To organise your own Open Space session, simply book a free time slot and room
via our
[Open Spaces registration calendar](https://calendar.google.com/calendar/u/0?cid=Y18zYzU5ODY4ZTFiY2Q5MmM4OWFhNjc2YTQ0M2FhNDFhOGIxNjk0YzY3MzVlNmY0MzZkNGU4MDdiNTk0ZjA5MjlkQGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20)
— this allows you to easily secure a space to host your discussion or
presentation. Once booked, your session will be listed on the [schedule](https://ep2026.europython.eu/schedule/) shortly.

Rooms S4(1,2,3), S4(4), and S4(5) will be reserved exclusively for Open Space
sessions. You can book one of these spaces by using the links below:
...
Please note that:
- Room S4(1,2,3) can accommodate 48 people and has a 85'' monitor
- Room S4(4) can accommodate 24 people and has no monitor
- Room S4(5) can accommodate 36 people and has a 85'' monitor
