...
<h4 id="bloomberg1-senior-software-engineer-multi">Senior Software Engineer - Multi-Asset Risk System</h4>

We are looking for a Senior Software Engineer with:
- Experience working with an object-oriented programming language (C/C++, Python, Java, etc.)
- A Degree in Computer Science, Engineering, Mathematics, similar field of study or equivalent work experience
- Commercial software engineering experience covering the full development life-cycle
