...
---
## [CodSpeed](http://codspeed.io)
[CodSpeed](http://codspeed.io) is a software performance optimization tool that allows engineering teams to optimize and measure code performance before it is deployed to production or shipped anywhere. Thanks to this approach, we avoid regressions that impact user experience and help developers solve their performance issues faster. CodSpeed is already trusted as the go-to solution for performance optimizations by top-tier open-source project teams such as Pydantic, Ruff, and Prisma.

We’re at an exciting early stage and looking for talented engineers who share our passion for helping to enhance the performance of software used by billions of people, improving the software development lifecycle, and building tools we love to use ourselves."

<h4 id="codspeed1-founding-ai-engingeer">Founding AI Engineer</h4>

<h5>What you’ll do</h5>

- Build language models applications focused on code performance, both to infer the performance of a code snippet statically and also to optimize it without any runtime information
- Fine tune and train language models with our own high quality datasets to improve the relevance of our suggestions and analysis
- Be a founding engineer - you’ll make core architecture choices, ship significant features to production, and shape the company culture

<h5>Requirements</h5>

- Strong programming skills in Python
- Experience working with LLMs(prompt engineering, RAG, orchestration, …)
- Experience building AI models and deploying them to production
- Deeply care about technical excellence

<h5>Extras</h5>

- Experience with Python web backend frameworks (eg: FastAPI) or frontend frameworks (eg: React)
- Open-source projects or contributions
- Experience leading significant projects in startup environments

✉️ To apply, reach out to [careers@codspeed.io](mailto:careers@codspeed.io) with a resume, and we’ll get back to you shortly.


<h4 id="codspeed2-founding-systems-engingeer">Founding Systems Engineer</h4>

<h5>What you’ll do</h5>

- Build the next generation of high-performance CPU simulation tooling to improve how we measure performance
- Work with high-level language interpreter codebases (CPython, V8, …) to enhance our instrumentation quality
- Build various kernel’s I/O emulations to provide robust performance metrics agnostically from the hardware
- Be a founding engineer - you’ll make core architecture choices, ship significant features to production, and shape the company culture

<h5>Requirements</h5>

- Experience in a System Programming language: C, C++, Zig or Rust
- Understanding of Unix systems and kernels
- Deeply care about technical excellence

<h5>Extras</h5>

- Deep understanding of modern CPU Architectures
- Experience with Javascript and Python runtime internals and optimization pipelines
...
Explore the opportunities at Pure Storage and find your next job with us!

<h4 id="senior-sw-engineer-engineering-productivity-flasharray">Senior SW Engineer, Engineering Productivity, FlashArray</h4>

**Responsibilities**

- Design and develop automated test frameworks and infrastructure for all-flash storage arrays.
- Excel in software test automation, constructing test platforms and pipelines to elevate code delivery quality via distributed systems, employing hardware, VMs, or Cloud technologies.
- Enhance product quality and the reliability of automated testing infrastructure.
- Collaborate with elite storage engineers, contributing to test automation requirements during product design reviews.
- Thrive in a collaborative, transparent, and agile environment.
- Innovate ways to create more efficient products by harnessing open-source technologies.
- Collaborate across support, release, engineering, and management teams to enhance product quality through expanded automated test coverage.
- Embrace a flat organizational structure, taking on challenges proactively, and assuming responsibilities for customer-centric outcomes, primarily catering to internal engineering teams.

[Visit here to read more](https://intcareers-purestorage.icims.com/jobs/5168/python-engineer-%28devtest%29%2c-flasharray/job?mobile=false&width=1140&height=500&bga=true&needsRedirect=false&jan1offset=60&jun1offset=120)


<h4 id="senior-sre-flasharray">Senior Site Reliability Engineer,FlashArray</h4>
...
[Visit here to read more](https://intcareers-purestorage.icims.com/jobs/5208/senior-site-reliability-engineer%2cflasharray/job?mobile=false&width=1140&height=500&bga=true&needsRedirect=false&jan1offset=60&jun1offset=120)


<h4 id="principal-software-engineer-cloud-costs">Principal Software Engineer in Cloud Costs</h4>

**Responsibilities**

- Detailed understanding of our cloud infrastructure, the services it supports, and its cost structure
- Working on full lifecycle application development of internal cost and usage collection, analysis and reporting services and data pipelines
- Working on setting up best practices, standards, and governance processes for cloud cost control
- Working with stakeholders like Engineering, Operations, Finance, Leadership, or Product Management to understand their cloud infrastructure cost/usage awareness needs
- Reporting cloud infrastructure cost & usage to the above mentioned stakeholders
- Monitoring & analyzing our cloud infrastructure costs & usage to identify and document spikes, trends, their drivers
- Identifying and assessing cloud infrastructure cost optimization opportunities, helping ensure that they are acted on
- Popularizing the usage of the produced reports, helping other teams understand this data, train them on it
