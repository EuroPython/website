...
at [ICE Kraków Congress Centre's Accessibility Info Section](https://icekrakow.pl/en/practical-informations/disabled).

### Entrance to the venue

- The venue is accessible for wheelchair users.
- The main entrance to the building (off Barska Street) does not have exterior steps or thresholds. At the main entrance, next to the revolving doors, is an additional door on the left hand side, which is activated by a photo cell. In addition, there is a ramp for wheelchairs.

![ICE main entrance](./accessibility-main-entrance.png)
...
- Toilets with larger cabins and was basins are available on the **ground floor**.
- Gender-neutral toilets are available on . #TODO
- Baskets with toiletries are placed at female and gender neutral bathrooms.

##### Quiet Room (3rd floor)

![ICE Quiet Room Location](./a11y-quiet-room.png)
...
- If you feel overwhelmed and need a quiet space with no distractions, feel free to visit **Room VIP F2** on the **2nd floor**.
