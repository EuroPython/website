...
Registered ticket holders can also reach out via the Discord server using the *#support* channel.
Please use the 'Accessibility' tag, and we will respond as soon as we can.
...
- Location: The bag is placed at the Info Desk in the Registration area, and in the low stimulation room.
...
![Examples of fidget and stim toys of various shapes and sizes](./a11y-fidget-toys.jpg)
...
Menus and related dietary information will be provided each day to help you identify suitable options. All allergens will be marked at the food stations.
If you have any issues identifying suitable options for your requirements, please head to the registration desk for help, or ask one of our friendly volunteers (in yellow t-shirts) for assistance.
...
- There are toilets available on every floor that are adapted to the needs of those with reduced mobility.
- Toilets with larger cabins and wash basins are available on the **ground floor**.
- Period products will be available.
- There are gender neutral toilets on the upper floors, F2 and F3, on either end of the main halls.

![Image indicating the gender neutral toilets location](./a11y-gender-neutral-toilet.jpg)
...
- If you feel overwhelmed and need a quiet space with no distractions, feel free to visit **VIP F2** on the **2nd floor**. The room is marked "VIP area" on the venue signs.

- We have signposts throughout the venue to help you find the low-stim room. Please note it is NOT accessible via stairs. You will need to take the lift to F3, then follow the signs towards the S4 rooms. Here there is a lift to take you to the F2 rooms. Please reach out if you have any issue finding your way.

- The room is intentionally kept dark (you may find your phone torch useful!) and empty.

![Signpost showing instructions to find F2 rooms](./a11y-f2rooms-access.jpg)
...
There will be three seats reserved in the front row of all of the sessions.
Please feel free to use these should they help if you have reduced mobility, are hard of hearing, or for any other reason.

## Sprints Venue (Saturday-Sunday)

The Sprints Venue is [Echo Miasta](/sprints/#heading-1).

The sessions will take place on the 1st and 2nd floor, which are accessible via elevator.
There are also accessible bathrooms available on both floors.

## Social Event Venue

Most details about the Social Event can be found on the [event page](/social-event).
In terms of accessibility:

- Everything is located on the ground floor. You can enter via the side entrance from the parking lot, where there is a ramp to the entryway.
- There is an accessible bathroom.
- There will be no music at the event, and there will be a quieter space for board games.
- Please note, however, that the venue will, of course, still be noisy and there will be lots of activity. The arcade games and bowling rooms will have bright and flashing lights.
