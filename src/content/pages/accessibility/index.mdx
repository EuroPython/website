...
- If you feel overwhelmed and need a quiet space with no distractions, feel free to visit **Room Red VIP F2** on the **2nd floor**. The room is
marked "VIP area" on the venue signs.

- We have signposts throughout the venue to help you find the low-stim room. Please note it is NOT accessible via stairs.
You will need to take the lift to F3, then follow the signs towards the S4 rooms. Here there is a lift to take you to the F2 rooms.
Please reach out if you have any issue finding your way.
...
- Everything is located on the ground floor. You can enter via the side entrance from the parking lot,
where there is a ramp to the entryway.
- There is an accessible bathroom.
- There will be no music at the event, and there will be a quieter space for board games.
- Please note, however, that the venue will, of course, still be noisy and there will be lots of activity. The arcade games and
bowling rooms will have bright and flashing lights.
