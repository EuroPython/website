...
🏛️ <a href="/krakow" class="text-primary hover:text-primary-hover underline">Kraków, Poland</a>
  ...
  <div class="bg-[var(--color-surface-subtle)] p-6 rounded-lg w-full border border-[var(--color-border)]">
...
<div class="bg-[var(--color-surface-subtle)] p-6 rounded-lg border border-[var(--color-border)]">
