...
The conference will return to **Kraków, Poland**, with the main conference hosted at the [ICE Kraków Congress Centre (ICE)](https://icekrakow.pl/en).
...
The key deadlines are **9 April 2026** (first round) and **11 May 2026** (second round). Please apply via the [Financial Aid page](/finaid).
