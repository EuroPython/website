...
<ul className="milestone-done">
  ...
  <li>**18 March 2026** [Financial Aid](/finaid) Programme applications open</li>
...
<ul className="milestone-todo">
  ...
  <li>**6 April 2026** Financial Aid Programme first-round application deadline</li>
  <li>**8 May 2026** Financial Aid Programme second-round application deadline</li>
...
Applications opened on **18 March 2026**.
The key deadlines are **6 April 2026** (first round) and **8 May 2026** (second round). Please apply via the [Financial Aid page](/finaid).
