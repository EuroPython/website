...
An online panel session with invited experienced speakers sharing advice all first-time (or other) speakers. At the end of the panel, there will be a QnA session to answer all the participants' questions. The event has a public format. Every participant will have to register through this [form](https://forms.gle/uK4VKpCb9kDu5rRz7). Close to the date of the event we will share the event details via the registered email.
