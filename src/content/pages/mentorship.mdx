...
An online panel session with invited experienced speakers sharing advice all first-time (or other) speakers. At the end of the panel, there will be a QnA session to answer all the participants' questions. The event has a public format. Every participant will have to register by clicking on the the link below. Close to the date of the event we will share the event details via the registered email.

<div style={{textAlign: "center", marginBottom: 15}}>
<Button children="Apply for First-Time Speaker Workshop" href="https://forms.gle/uK4VKpCb9kDu5rRz7" />
</div>
