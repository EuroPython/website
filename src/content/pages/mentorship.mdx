...
speakers who want help preparing for their contribution. To achieve this, we are
running the Speaker Mentorship Programme again.
...
are interested in helping mentees as their mentor please register
[here](https://forms.gle/CjaWHxrpjqmZtmVC9)
...
### First-Time Speaker Workshop - Monday, 3rd June, 19:00 CEST

An online panel session with invited experienced speakers sharing advice all
first-time (or other) speakers. At the end of the panel, there will be a QnA
session to answer all the participants' questions. The event has a public
format. Every participant will have to register by clicking on the the link
below. Close to the date of the event we will share the event details via the
registered email.

<div style={{ textAlign: "center", marginBottom: 15 }}>
  <Button
    children="Apply for First-Time Speaker Workshop"
    href="https://forms.gle/uK4VKpCb9kDu5rRz7"
  />
</div>

### [COMPLETED] Ask Me Anything about CFP Workshop - Monday, 26 February, 18:30 CET

Thank you, everyone who joined the session with your questions! You can view the
