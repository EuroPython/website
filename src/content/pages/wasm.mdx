...
* **Who can join**: Anyone with a valid in-person EuroPython 2023 ticket - Conference, Tutorial or Combined (see [ticket types](https://ep2024.europython.eu/tickets#ticket-types) for details).
