...
[DB Schenker](https://www.dbschenker.com/cz-en). Please contact
Martin ULIČNÝ and Robin Veselý from DB Schenker directly to discuss costs and shipping arrangements.
...
**Deadlines**
- DB Schenker should receive the shipments by **1st of July**.
- You can find the complete list of delivery information in the  [Shipping Guidelines & Address (.doc)](https://docs.google.com/document/d/1vtydTQNkLDp2e4NrMg0VIhc2AYM8zMOK/view).
...
or workshop/tutorial. You can find the details for each:
...
**Deadline** for informing us of the presenter, presentation title & abstract: **3 June, 2024**
...
job ad on our [Job Board](/job-board) page. If you
...
The 60 min recruiting session will take place on 11th of July at 14:00
in room South Hall 2A. You can refer to the [schedule](/schedule/) for more
details: https://ep2024.europython.eu/session/sponsor-highlight-recruitment-fair.
