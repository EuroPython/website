...
- **sprint rooms** - all on the 1st floor of RB (plus RB209 on the 2nd floor)
- **chillout area**: the
...
Room 209 (upstairs) has capacity for 48 and looks like
...
- Please fork and clone the repo before coming to the venue in case of slow wifi :) https://github.com/python/cpython
- Links:
...
### Pygount
    ...
    Room: RB 107
    Python Level: any
    Contact person: Thomas Aglassinger ([roskakori](https://github.com/roskakori))
    Links:
    - [PyPI](https://pypi.org/project/pygount/)
    - [Documentation](https://pygount.readthedocs.io/en/latest/index.html)
    - [issues](https://github.com/roskakori/pygount/milestone/22)
    - [Contribution guidelines](https://pygount.readthedocs.io/en/latest/contributing.html)

### eGenix PyRun
- Number of people: maybe 2-3 (1 maintainer + perhaps 1-2 contributors, but open to more)
- Room: RB 106
...
### PyO3 workshop
- Number of people: 24 (24 participants + Cheuk)
- Room: RB 104 (Saturday morning Only)
- Python Level: Some Python knowledge, no Rust knowledge required for learning (doing the 101 workshop), some Rust knowledge needed for contributing.
- Contact person: Cheuk (me [at] cheuk.dev)
- Links:
  - https://github.com/Cheukting/py03_101
  - https://github.com/PyO3
- Description: For folks who are not familiar with PyO3 and want to learn, we will be doing a PyO3 101 workshop. For folks who are interested in contributing to PyO3, I can give a brief introduction to the PyO3 code base (I am not a maintainer but I am a contributor to PyO3) and maybe work on a PR together.

### Prepare your next CfP
- Number of people: 24 (24 participants + Cheuk)
- Room: RB 104 (Saturday afternoon Only)
- Python Level: Any
- Contact person: Cheuk (me [at] cheuk.dev)
- Links: https://cheuk.dev/public-speaking.html
- Description: Are you inspired to speak at the next EuroPython (or other Python events)? Are you a new speaker? Cheuk will spend an afternoon to help you start writing a CfP and overcoming the fear of public speaking.

### SPDT Python Library
- Number of people: ~6 (5 contributors + 1 organiser)
- Room: RB 106
- Python Level: Any
- Contact person: Kayode Oladapo (oladapoka@mcu.edu.ng)
- Links: https://github.com/oladapokayodeabiodun/spdt

### Data Morph
- Number of people: 4 (2-3 contributors + 1 maintainer)
- Room: RB 106 (Saturday only)
- Python Level: intermediate
- Contact person: Stefanie Molin ([@stefmolin](https://github.com/stefmolin))
- Links:
  ...
  - [Sprintable issues](https://github.com/stefmolin/data-morph/issues?q=is%3Aissue+label%3A%22help+wanted%22+is%3Aopen)

### Bracelet weaving workshop
- Number of people: 10 (10 weavers + Nika)
- Room: RB 112
- Python Level: Any
- Contact person: Nika
- Links: https://github.com/EuroPython
- Description: Nika's workshop is a wonderful opportunity to create your own unique bracelet and bring it back as a memorable keepsake from the conference. Whether you are a seasoned weaver or a complete beginner, all are welcome to participate and have fun 🙂
We look forward to seeing you there!

### CircuitPython
- Number of people: 7 (6 contributors + 1 organisers)
- Room: RB 114
- Python Level: Any
- Contact person: Radomir Dopieralski (ep2024 at dopieralski.pl)
