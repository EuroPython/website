...
- Room: RB 105
- Python Level: Any
- Contact person: Kayode Oladapo (https://github.com/oladapokayodeabiodun)
- Links: https://sites.google.com/view/kayodeabiodunoladapo
- Description: Proposing a new Python Library for building decision tree classifiers. This is to be especially designed for classifying large data sets and streaming data.
